...
Ко всем работам написаны тесты (doctest, bash-testing), но представлена лишь часть.\
Dсё протестировано на разных системах, компиляторах (GCC, Clang, MSVC, Apple Clang) и разных режимах запуска (ASan, Valgrind, Release). 
